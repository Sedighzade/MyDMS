...
namespace ScottPlot.Drawing
{
    public static class InstalledFont
    {
        ...
        public static string Serif() => ValidFontName(new string[] { "Times New Roman", "DejaVu Serif", "Times" });

        public static string Sans() => ValidFontName(new string[] { "Segoe UI", "DejaVu Sans", "Helvetica" });

        public static string Monospace() => ValidFontName(new string[] { "Consolas", "DejaVu Sans Mono", "Courier" });
